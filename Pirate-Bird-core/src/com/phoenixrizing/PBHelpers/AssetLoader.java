package com.phoenixrizing.PBHelpers;
...
public class AssetLoader {
	...
	public static TextureRegion logo, cbLogo, bg, grass, bird, birdDown,
    ...
    public static TextureAtlas pbTexture;

    public static void load() {

        pbTexture = new TextureAtlas(Gdx.files.internal("PBTexture.txt"));
        ...
        scoreboard = pbTexture.findRegion("Scoreboard");
		...
		cbLogo = new TextureRegion(texture, 0, 55, 135, 24);
		cbLogo.flip(false, true);
		...
		prefs = Gdx.app.getPreferences("PirateBird");
